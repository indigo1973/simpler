...
struct PTO2OrchestratorState {
    ...
    // Runtime profiling switch: set to Runtime::enable_profiling before orch runs.
    // Exists whenever either scheduling-log profiling (PTO2_PROFILING) or
    // swimlane collection (PTO2_PERF_LEVEL>=1) is compiled in.
