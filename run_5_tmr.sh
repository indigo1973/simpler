#!/usr/bin/env bash
# Profiling level verification for tensormap_and_ringbuffer runtime (paged_attention_unroll).
#
...
#
# Usage:
#   ./run_5_tmr.sh [-d <device>] [-n <runs>] [-w <warmup>]
...
echo ""
echo "================================================================"
echo "  Profiling Level Verification (tensormap_and_ringbuffer)"
